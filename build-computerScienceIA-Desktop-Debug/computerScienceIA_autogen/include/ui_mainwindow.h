...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        selectedTaskBox_2->setGeometry(QRect(490, 20, 391, 151));
        textEdit = new QTextEdit(selectedTaskBox_2);
        textEdit->setObjectName("textEdit");
        textEdit->setGeometry(QRect(10, 100, 371, 41));
        QFont font;
        font.setPointSize(16);
        textEdit->setFont(font);
        toolButton = new QToolButton(selectedTaskBox_2);
        toolButton->setObjectName("toolButton");
        toolButton->setGeometry(QRect(350, 110, 26, 25));
        radioButton = new QRadioButton(selectedTaskBox_2);
        radioButton->setObjectName("radioButton");
        radioButton->setGeometry(QRect(20, 40, 71, 41));
